...
return 0;
  ...
  const handleNext = () => {
    const nextTaskId = getNextTaskId('letter_copy', currentDisease);
    if (nextTaskId) {
  ...
  const instructions = (
    <Instructions>
      <InstructionText>• Copy each letter exactly as shown: A B C D E</InstructionText>
      <InstructionText>• Pay attention to size and spacing</InstructionText>
      <InstructionText>• Write clearly and legibly</InstructionText>
