...
const LetterCopyTest: React.FC = () => {
  ...
  const [timeRemaining, setTimeRemaining] = useState<number | null>(60); // 60 seconds for letter copying
  ...
  const instructionsContent = (
    <>
      <p>Copy each letter exactly as shown</p>
      <p>Pay attention to size and spacing</p>
  ...
  return (
    <TestContainer>
      <div className="container">
        <TestHarness title="Letter Copying"
          instructions={instructionsContent}
          onQuit={handleQuitTest}
          onPause={handlePauseToggle} step={1} totalSteps={21}
        >
          <ReferenceArea>
            <ReferenceText>A B C D E</ReferenceText>
          </ReferenceArea>

          <Instructions>
            <InstructionsText>
              Copy these letters exactly as shown above
            </InstructionsText>
          </Instructions>
          ...
          <ButtonContainer>
            <Button to="/test/spiral_drawing" $primary={false}>
              <ArrowLeft size={20} />
              Previous Task
            </Button>
            <Button to="/test/word_copy" $primary={true}>
              Next Task
              <ArrowRight size={20} />
            </Button>
          </ButtonContainer>
