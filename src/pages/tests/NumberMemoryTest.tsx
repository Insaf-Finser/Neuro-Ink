...
return 0;
  ...
  const handleNext = () => {
    const nextTaskId = getNextTaskId('number_memory', currentDisease);
    if (nextTaskId) {
  ...
  const instructions = (
    <Instructions>
      <InstructionText>• Remember this sequence: 7-4-2-9-1-6</InstructionText>
      <InstructionText>• After 30 seconds, write it from memory</InstructionText>
      <InstructionText>• Keep the numbers in the same order</InstructionText>
