...
const NumberCopyTest: React.FC = () => {
  ...
  const [timeRemaining, setTimeRemaining] = useState<number | null>(45); // 45 seconds for number copying
  ...
  const instructionsContent = (
    <>
      <p>Copy each number exactly as shown</p>
      <p>Keep numbers evenly spaced</p>
      <p>Make them clear and readable</p>
  ...
  return (
    <TestContainer>
      <div className="container">
        <TestHarness title="Number Copying"
          instructions={instructionsContent}
          onQuit={handleQuitTest}
          onPause={handlePauseToggle} step={1} totalSteps={21}
        >
          <ReferenceArea>
            <ReferenceText>1 2 3 4 5</ReferenceText>
          </ReferenceArea>

          <Instructions>
            <InstructionsText>
              Copy these numbers exactly as shown above
            </InstructionsText>
          </Instructions>
          ...
          <WritingArea>
            ...
            <div style={{ 
              ...
              {hasStarted ? 'Write your numbers here...' : 'Click "Start Task" button to begin writing'}
            </div>
            {stylusCapabilities && (
              <div style={{ 
                position: 'absolute', 
          ...
          <ButtonContainer>
            <Button to="/test/word_copy" $primary={false}>
              <ArrowLeft size={20} />
              Previous Task
            </Button>
            <Button to="/test/complex_figure_copy" $primary={true}>
              Next Task
              <ArrowRight size={20} />
            </Button>
          </ButtonContainer>
