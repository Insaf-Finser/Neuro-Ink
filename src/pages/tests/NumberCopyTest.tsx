...
return 0;
  ...
  const handleNext = () => {
    const nextTaskId = getNextTaskId('number_copy', currentDisease);
    if (nextTaskId) {
  ...
  const instructions = (
    <Instructions>
      <InstructionText>• Copy each number exactly as shown: 1 2 3 4 5</InstructionText>
      <InstructionText>• Keep numbers evenly spaced</InstructionText>
      <InstructionText>• Make them clear and readable</InstructionText>
