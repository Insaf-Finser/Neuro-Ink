...
const TriangleDrawingTest: React.FC = () => {
  ...
  const evaluateDrawing = async () => {
    ...
    setIsAnalyzing(true);
    try {
      const validation = validateDrawing({ type: 'triangle' }, strokes, canvasSize);
  ...
  const instructions = (
    <Instructions>
      ...
      <InstructionText>• Make sure all angles are equal</InstructionText>
      <InstructionText>• Connect the lines properly</InstructionText>
