...
const TriangleDrawingTest: React.FC = () => {
  ...
  const [timeRemaining, setTimeRemaining] = useState<number | null>(30); // 30 seconds for triangle drawing
  ...
  const instructionsContent = (
    <>
      <p>Draw a triangle with three equal sides</p>
      <p>Make sure all angles are equal</p>
      <p>Connect the lines properly</p>
  ...
  return (
    <TestContainer>
      <div className="container">
        <TestHarness title="Triangle Drawing"
        ...
        >
          ...
          <DrawingArea>
            ...
            <div style={{ 
              ...
              {hasStarted ? 'Draw your triangle here...' : 'Click to begin drawing'}
            </div>
            {stylusCapabilities && (
              <div style={{ 
                position: 'absolute', 
          ...
          <ButtonContainer>
            <Button to="/test/square_drawing" $primary={false}>
              <ArrowLeft size={20} />
              Previous Task
            </Button>
            <Button to="/test/pentagon_drawing" $primary={true}>
              Next Task
              <ArrowRight size={20} />
            </Button>
          </ButtonContainer>
...
export default TriangleDrawingTest;
