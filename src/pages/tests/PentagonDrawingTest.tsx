...
const PentagonDrawingTest: React.FC = () => {
  ...
  const instructionsContent = (
    <>
      <p>Draw a regular pentagon (five-sided shape)</p>
      <p>Make all sides equal length</p>
      <p>Try to make it as regular as possible</p>
  ...
  return (
    <TestContainer>
      <div className="container">
        <TestHarness title="Pentagon Drawing"
        ...
        >
          ...
          <DrawingArea>
            ...
            <div style={{ 
              ...
              {hasStarted ? 'Draw your pentagon here...' : 'Click to begin drawing'}
            </div>
            {stylusCapabilities && (
              <div style={{ 
                position: 'absolute', 
          ...
          <ButtonContainer>
            <Button to="/test/triangle_drawing" $primary={false}>
              <ArrowLeft size={20} />
              Previous Task
            </Button>
            <Button to="/test/spiral_drawing" $primary={true}>
              Next Task
              <ArrowRight size={20} />
            </Button>
          </ButtonContainer>
