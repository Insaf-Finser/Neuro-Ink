...
return 0;
  ...
  const handleNext = () => {
    const nextTaskId = getNextTaskId('word_copy', currentDisease);
    if (nextTaskId) {
  ...
  const instructions = (
    <Instructions>
      <InstructionText>• Copy each word exactly as shown: CAT DOG HOUSE</InstructionText>
      <InstructionText>• Maintain proper spacing between words</InstructionText>
      <InstructionText>• Keep letters the same size</InstructionText>
