...
const WordCopyTest: React.FC = () => {
  ...
  const instructionsContent = (
    <>
      <p>Copy each word exactly as shown</p>
      <p>Maintain proper spacing between words</p>
      <p>Keep letters the same size</p>
  ...
  return (
    <TestContainer>
      <div className="container">
        <TestHarness title="Word Copying"
          instructions={instructionsContent}
          onQuit={handleQuitTest}
          onPause={handlePauseToggle} step={1} totalSteps={21}
        >
          <ReferenceArea>
            <ReferenceText>CAT DOG HOUSE</ReferenceText>
          </ReferenceArea>

          <Instructions>
            <InstructionsText>
              Copy these words exactly as shown above
            </InstructionsText>
          </Instructions>
          ...
          <WritingArea>
            ...
            <div style={{ 
              ...
              {hasStarted ? 'Write your words here...' : 'Click "Start Task" button to begin writing'}
            </div>
            {stylusCapabilities && (
              <div style={{ 
                position: 'absolute', 
          ...
          <ButtonContainer>
            <Button to="/test/letter_copy" $primary={false}>
              <ArrowLeft size={20} />
              Previous Task
            </Button>
            <Button to="/test/number_copy" $primary={true}>
              Next Task
              <ArrowRight size={20} />
            </Button>
          </ButtonContainer>
