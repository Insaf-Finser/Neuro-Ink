...
const RapidWritingTest: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleStrokeEnd = (event: CustomEvent) => {
      ...
      setIsWriting(false);
      setCurrentStroke([]);
      // Increment word count when stroke ends (assuming each stroke is a word)
  ...
  const getStatusText = () => {
    ...
    if (isWriting) return 'Writing rapidly...';
  ...
  const instructionsContent = (
    <>
      <p>Write the word "the" as quickly as you can</p>
      <p>Repeat it 10 times</p>
      <p>Don't worry about perfect handwriting</p>
  ...
  return (
    <TestContainer>
      <div className="container">
        <TestHarness title="Rapid Writing"
        ...
        >
          <Instructions>
            <InstructionsText>
              Write the word "the" as quickly as possible, repeat 10 times
            </InstructionsText>
          </Instructions>

          <SpeedIndicator>
            Words Written: {wordCount} / 10
          </SpeedIndicator>
          ...
          <WritingArea>
            ...
            <div style={{ 
              ...
              {hasStarted ? 'Write "the" rapidly here...' : 'Click "Start Task" button to begin writing'}
            </div>
            {stylusCapabilities && (
              <div style={{ 
                position: 'absolute', 
          ...
          <ButtonContainer>
            <Button to="/test/number_memory" $primary={false}>
              <ArrowLeft size={20} />
              Previous Task
            </Button>
