...
const SignaturePracticeTest: React.FC = () => {
  ...
  const getStatusText = () => {
    ...
    if (isWriting) return 'Writing signature...';
  ...
  const instructionsContent = (
    <>
      <p>Write your signature as you normally would</p>
      <p>Make it clear and legible</p>
      <p>Use your natural handwriting style</p>
  ...
  return (
    <TestContainer>
      <div className="container">
        <TestHarness title="Signature Practice"
        ...
        >
          ...
          <WritingArea>
            ...
            <div style={{ 
              ...
              {hasStarted ? 'Write your signature here...' : 'Click "Start Task" button to begin writing'}
            </div>
            {stylusCapabilities && (
              <div style={{ 
                position: 'absolute', 
          ...
          <ButtonContainer>
            <Button to="/test/repetitive_writing" $primary={false}>
              <ArrowLeft size={20} />
              Previous Task
            </Button>
