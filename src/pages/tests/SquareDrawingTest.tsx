...
const SquareDrawingTest: React.FC = () => {
  ...
  const [timeRemaining, setTimeRemaining] = useState<number | null>(30); // 30 seconds for square drawing
  ...
  const handleCompleteTask = async () => {
    ...
    try {
      ...
      await completeTaskAndNavigate(completionData, 'triangle_drawing');
    } catch (error) {
  ...
  const instructionsContent = (
    <>
      <p>Draw a square with equal sides</p>
      <p>Make sure all angles are 90 degrees</p>
      <p>Keep the lines straight and connected</p>
  ...
  return (
    <TestContainer>
      <div className="container">
        <TestHarness title="Square Drawing"
        ...
        >
          ...
          <DrawingArea>
            ...
            <div style={{ 
              ...
              {hasStarted ? 'Draw your square here...' : 'Click "Start Task" button to begin drawing'}
            </div>
            {stylusCapabilities && (
              <div style={{ 
                position: 'absolute', 
          ...
          <ButtonContainer>
            <Button to="/test/circle_drawing" $primary={false}>
              <ArrowLeft size={20} />
              Previous Task
            </Button>
            <Button to="/test/triangle_drawing" $primary={true}>
              Next Task
              <ArrowRight size={20} />
            </Button>
          </ButtonContainer>
