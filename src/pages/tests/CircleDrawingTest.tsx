...
const CircleDrawingTest: React.FC = () => {
  ...
  const instructions = (
    <Instructions>
      <InstructionText>• Draw a circle as round and smooth as possible</InstructionText>
      <InstructionText>• Try to make it as close to a perfect circle as you can</InstructionText>
      <InstructionText>• Take your time and focus on smooth movements</InstructionText>
